...
FORWARD_CHANNEL_ID = --1001434994505
CHANNEL_ID = --1001434994505
error_channel_id = --1001434994505
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/CrackModGamer*", parse_mode='Markdown')
